<?php  include'files\overall\overallheader.php' ;?>
 <body>
<form  action="welcome.php" onsubmit="send()" method="POST">
<label for="">Username</label>
<input type="text" name="name" id="" placeholder="Enter your name ">

<label for="">Email address</label> 
<input type="text" name="email" id="" placeholder="Enter your email ids">
<label for="">CNIC NO</label>
<input type="password" name="cnic" id="" placeholder="Enter your CNIC ">
